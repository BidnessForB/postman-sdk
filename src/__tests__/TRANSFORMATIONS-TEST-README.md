...
npm test -- src/__tests__/transformations-functional.test.js

# Run with verbose output
npm test -- src/__tests__/transformations-functional.test.js --verbose

# Run specific transformation direction
npm test -- src/__tests__/transformations-functional.test.js --testNamePattern="spec-to-collection"
npm test -- src/__tests__/transformations-functional.test.js --testNamePattern="collection-to-spec"

# Run specific test group
npm test -- src/__tests__/transformations-functional.test.js --testNamePattern="syncSpecWithCollection"
npm test -- src/__tests__/transformations-functional.test.js --testNamePattern="syncCollectionWithSpec"
```
