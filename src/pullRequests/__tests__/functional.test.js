...
describe('Pull Request Management Functional Tests', () => {
  ...
  beforeAll(async () => {
    ...
    if (!persistedIds.pullRequest?.id) {
      throw new Error('Pull Request ID not found in test-ids.json. Run collection PR functional tests first.');
    }

    console.log('Using user ID:', userId);
    console.log('Using pull request ID:', persistedIds.pullRequest.id);
  });
