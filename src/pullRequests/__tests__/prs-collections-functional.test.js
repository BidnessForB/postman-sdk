...
describe('Collection Pull Request Functional Tests', () => {
  ...
  test('100. getPullRequest - should retrieve pull request details', async () => {
  ...
  test('103. reviewPullRequest - should approve pull request', async () => {
    try {
  ...
  test('104. reviewPullRequest - should unapprove pull request', async () => {
    try {
      const result = await reviewPullRequest(
        persistedIds.pullRequest.id,
        'unapprove'
  ...
  test('105. reviewPullRequest - should decline pull request with comment', async () => {
    try {
  ...
  test('106. getPullRequest - should handle invalid PR ID', async () => {
  ...
  test('108. reviewPullRequest - should handle invalid PR ID', async () => {
    const fakeId = '00000000-0000-0000-0000-000000000000';
