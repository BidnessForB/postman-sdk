...
describe('Pull Requests Collection Functional Test Suite', () => {
  beforeAll(() => {
  ...
  */
  ...
  describe('Phase 1: Collection Pull Request Functional Tests', () => {
    const collectionFunctionalTests = require('./collections/functional.test');
    // Tests are automatically executed when the module is required
  });

  describe('Phase 2: Pull Request Functional Tests', () => {
    const prFunctionalTests = require('./functional.test');
    // Tests are automatically executed when the module is required
  });
